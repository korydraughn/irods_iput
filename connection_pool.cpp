...
connection_pool::connection_proxy::operator rxComm_t&() const noexcept
{
    return conn_;
}

connection_pool::connection_proxy::connection_proxy(connection_pool& _pool, rxComm_t& _conn, int _index) noexcept
    : pool_{_pool}
    , conn_{_conn}
    , index_{_index}
{
...
void connection_pool::return_connection(int _index) noexcept
{
